	 ...
	 <c:forEach items="${page.records}" var="a">
		<tr>
			...
			<table>
				...
				<tr><td width="80px"><p>详情：   </p></td><td width="80px"><p><a href="${pageContext.request.contextPath}/detail/pack?id=${a.id}&uid=${a.uid}&type=2">详细信息.....</a></p></td></tr>
			</table>
			</td class="td_3">
			<td width="10px"  height="150px"></td>   <!-- 设置间隔 -->
			<td class="td_3">
