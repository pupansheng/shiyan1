...
<table class="fabu">
<tr>
<td class="fabu_td1"><span>物品名称</span></td>
<td class="fabu_td1"><span>发布日期</span></td>
<td class="fabu_td1"><span>状态</span></td>
<td class="fabu_td1"><span>操作</span></td>
</tr>
...
<td><a href="javascript:void" onclick="fabu('${pageContext.request.contextPath}/lost/delete?id=${f.id}')" >取消发布</a></td>
</tr>
</c:forEach>
</table>
