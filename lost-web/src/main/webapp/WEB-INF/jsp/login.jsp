...
<body>
	<!-- header -->
	<div class="header">
		<img src="${pageContext.request.contextPath}/image/login_min.png">
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<img src="${pageContext.request.contextPath}/image/login.jpg" width="480px" height="383px">
		</div>
		<!-- login -->
		<div class="login">
			...
			<div class="login_box clear">
				<ul class="loginnav">
					<li class="curr" mark="sfbest">账号登陆</li>
				</ul>
				...
				<div class="logincon">
					...
					<form id="formlogin" method="post" >
						...
						<span style="position: absolute; font-size: 14px; left: 5px; top: 9px;display:none;" class="sfbest_username_place">请输入用户名</span>
							</span>
						...
						<li>
							<div style="width: 65px; margin-left: 260px;">
								<a class="forget-passWord" href="${pageContext.request.contextPath}/forget/password">忘记密码?</a>
							</div>
						</li>	
          ...
          <!--   <td width="100">验证码：</td>		
		    ...
		    <td width="135"><img id="imgObj" alt="" src="DrawImage"				onclick="changeImg()" />
		    <td><a href="#" onclick="changeImg()">换一张</a></td> -->
		<span class="title">验证码 </span> 
		
		<input id="veryCode" name="veryCode" type="text" class="login_yz" value="" />
	    <img id="imgObj" alt="" src="${pageContext.request.contextPath}/make/yanzhengma" onclick="changeImg()" />
	    <a href="#" onclick="changeImg()">换一张</a>
	 
	  </li>
	  <span style="line-height: 38px; color: #FF0000; text-align: center;" colspan="4" id="info"></span>
	...
	<!-- /login_main -->
	<div class="footer">
		<span> <a href="http://www.e3mall.cn/www/379/5109.html" rel="nofollow" class="footerlink1">免责声明</a> | 
		<a href="http://www.e3mall.cn/www/380/5116.html" rel="nofollow" class="footerlink1">关于我们</a> | 
		<a href="http://www.e3mall.cn/www/330/2705.html" rel="nofollow" class="footerlink1">网站合作</a> |
		<a href="http://www.e3mall.cn/www/330/2705.html" rel="nofollow" class="footerlink1">联系我们</a>
		</span>
		<p>
	...
	url = url.substring(0, 25);	if ((url.indexOf("&") >= 0)) 
	...
	function isRightCode() {
		...
		$.ajax({		
			type : "POST",		
			url : "${pageContext.request.contextPath}/check/yanzhengma",		
			data : code,		
			success : callback	});
		}
	...
	function check()
	{
		$.post("${pageContext.request.contextPath}/user/login.action", $("#formlogin").serialize(),function(data){
			if (data.status == 200) {
